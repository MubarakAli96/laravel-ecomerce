                ...
                <div class="row">
                  ...
                  <div class="col-md-12 pr-1">
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" value="{{ $permissions->name}}" name="name" id="formFile"
                        name="image" />
                    </div>
                  </div>
                  ...
                  <div class="col-md-12 pr-1">
                    <div class="form-group">
                      ...
                      <select name="group_name" class="form-select mb-3" aria-label="Default select example">
                        ...
                        <option value="category" {{$permissions->group_name =='category' ? 'selected' : '' }}>category
                        </option>
                        <option value="sub_category" {{$permissions->group_name =='sub_category' ? 'selected' : '' }}>
                          sub_category</option>
                      </select>
                    </div>
                  </div>

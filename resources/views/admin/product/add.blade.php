                ...
                <div class="border border-3 p-4 rounded">
                  <div class="row g-3">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" name="product_code" class="form-control" id="inputCostPerPrice" disabled
                        placeholder="00.00">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="row g-3">
                      <div class="col-6">
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" name="hot_deals" value=""
                            id="flexCheckDefault">
                      ...
                      <div class="col-6">
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" name="features" value=""
                            id="flexCheckDefault">

               ...
               <div class="border border-3 p-4 rounded">
                ...
                <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <textarea class="form-control" name="short_decription" id="inputProductDescription" rows="3"></textarea>
                  </div>
                  <div class="mb-3">
                ...
                <div class="border border-3 p-4 rounded">
                  <div class="row g-3">
                    ...
                    <div class="row g-3">
                      <div class="col-6">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="special_offers" value="" id="flexCheckDefault">
                            <label class="form-check-label" for="flexCheckDefault">Special Offers</label>
                        </div>
                      </div>
                      <div class="col-6">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="special_deals" value="" id="flexCheckDefault">

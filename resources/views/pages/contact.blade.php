        ...
        <div class="col-xl-10 col-lg-12 m-auto">
          <section class="row align-items-end mb-50">
            <div class="col-lg-4 mb-lg-0 mb-md-5 mb-sm-5">
              ...
              <p class="mb-20">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec
            ...
            <div class="row">
              <div class="col-xl-8">
                <div class="contact-from-area padding-20-row-col">
                  ...
                  <p class="text-muted mb-30 font-sm">Your email address will not be published. Required fields are
                    marked *</p>
                  <form class="contact-form-style mt-30" id="contact-form" action="{{ route('contact.store')}}"
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6 col-md-6">
                        <div class="input-style mb-20">
                          <input name="phone_no" placeholder="Your Phone" type="tel" />
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6">
                        <div class="input-style mb-20">
